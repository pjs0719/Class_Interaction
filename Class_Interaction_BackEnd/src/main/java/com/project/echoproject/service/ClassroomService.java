...
public class ClassroomService {
    ...
    @Autowired
    public ClassroomService(ClassroomRepository classroomRepository, ClassTimeRepository classTimeRepository, InstructorRepository instructorRepository, ScheduledExecutorService scheduledExecutorService) {
